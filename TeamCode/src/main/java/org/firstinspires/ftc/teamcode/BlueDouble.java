...
@Autonomous (name="Blue Double", group="Blue")

public class BlueDouble extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        if (skystone == true)
        {
            ...
            dT.backwards(0.3, 400);

            //Moves robot right to the foundation plate
            dT.left(0.25, 2000 + extraTick);

            //Moves the robot forward to move stone out of the way
            dT.forward(0.4, 250);
            ...
            //Moves robot clear of bridge
            dT.backwards(0.4, 250);

            dT.right(0.25,3140 + extraTick);
